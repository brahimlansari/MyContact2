...
public class Provider extends ContentProvider {
    ...
    public Uri insert( Uri uri,  ContentValues values) {
        ...
        switch (match){
            ...
            default:
                throw new IllegalArgumentException("cannot insert contact" + uri);
        }
    ...
    private Uri insertContact(Uri uri, ContentValues values) {
        ...
        if (number == null) {
            throw new IllegalArgumentException("number is requiered");
        }
        ...
        if (type == null || !Contract.ContactEntry.isValidType(type)) {
            throw new IllegalArgumentException("nme is requiered");
        }
