...
public class Editor extends AppCompatActivity implements  LoaderManager.LoaderCallbacks<Cursor>, LifecycleOwner {

    EditText mNameEditText, mNumberEditText, mEmailEditText;
    private Uri mPhotoUri;
    private Uri mCurrentContactUri;
    private String mType = Contract.ContactEntry.TYPECONTACT_PERSONAL;
    ImageView mPhoto;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mCurrentContactUri == null) {
            ...
            getSupportLoaderManager().initLoader(LOADER,null,null);
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (!TextUtils.isEmpty(selection)) {
                    if (selection.equals(getString(R.string.homephone))) {
                        mType = Contract.ContactEntry.TYPECONTACT_HOME;
                    } else if (selection.equals(getString(R.string.workphone))) {
                        mType = Contract.ContactEntry.TYPECONTACT_WORK;

                    } else {
                        mType = Contract.ContactEntry.TYPECONTACT_PERSONAL;
                    }
                }
            }
    ...
    private boolean saveContact() {
        ...
        if (mCurrentContactUri == null && TextUtils.isEmpty(name)
                && TextUtils.isEmpty(email) && TextUtils.isEmpty(phone) && mType == Contract.ContactEntry.TYPECONTACT_PERSONAL && mPhotoUri == null) {
    ...
    public Loader<Cursor> onCreateLoader(int id,  Bundle args)  {
        ...
        return new  androidx.loader.content.CursorLoader(this,mCurrentContactUri,projection,null,null,null);
    }

    @Override
    public void onLoadFinished(@androidx.annotation.NonNull Loader loader, Cursor cursor) {
        ...
        if (cursor.moveToFirst()) {
            ...
            switch (typeof) {
                ...
                case Contract.ContactEntry.TYPECONTACT_HOME:
                    mSpinner.setSelection(1);
                    break;

                case Contract.ContactEntry.TYPECONTACT_WORK:
    ...
    @Override
    public void onLoaderReset(@androidx.annotation.NonNull androidx.loader.content.Loader loader) {
    ...
    public Lifecycle getLifecycle() {
        return null; // <-- Return the lifecycle of this activity
    }
